      ...
      <article className='media'>
        ...
        <div className='media-left is-hidden-mobile'>
          <button
            ...
            onClick={props.voteHandler.bind(this, 'up', props.id)}>
            <i className="fa fa-arrow-up" aria-hidden="true"></i>
          </button>
          <p className='article-card-votes'><strong>{props.votes}</strong></p>
          <button className='button is-black is-inverted is-small down'
            onClick={props.voteHandler.bind(this, 'down', props.id)}>
